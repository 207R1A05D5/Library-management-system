...
<div class="card py-3 px-5 mb-3 col-12 ">
 ...
 <select class="form-control" name="rollno" placeholder="rollno.">
    <?php
        $res=mysqli_query($conn,"select rollno from issued_books where return_date=''");
 ...
 <?php
    if(isset($_POST['submit']))
    {
     echo" <div class='card py-3 px-5 mb-3 col-12'>";
      $res1=mysqli_query($conn,"select * from issued_books where rollno='$_POST[rollno]' and return_date=''");
