...
<div class="card py-3 px-5 mb-3 col-s-12 col-md-9 ">
 ...
 <select class="form-control" name="rollno" placeholder="rollno.">
    <?php
        $res=mysqli_query($conn,"select rollno from userinfo");
 ...
 <?php
    ...
    {
        $res1=mysqli_query($conn,"select * from userinfo where rollno='$_POST[rollno]'");
        ...
        <input type="text" name="rollno" class="form-control mt-2" value="<?php echo $rollno;?>" id="" placeholder="rollno" disabled>
...
{
 $query1 =   mysqli_query($conn,"INSERT INTO issued_books VALUES ('','$_SESSION[rollno]','$_POST[name]','$_POST[phone]','$_POST[email]','$_POST[issuedate]','$_POST[returndate]','$_POST[book_name]')");
